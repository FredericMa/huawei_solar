...
from huawei_solar.exceptions import HuaweiSolarException, InvalidCredentials, PermissionDenied, ReadException
    ...
    async def update(self) -> dict[str, Result]:
        ...
        async with self.update_lock:
            ...
            if self.battery_type != rv.StorageProductModel.NONE:
                result.update(await self._get_multiple_to_dict(ENERGY_STORAGE_UNIT_1_REGISTERS))
                result.update(await self._get_multiple_to_dict(ENERGY_STORAGE_REGISTERS))
                result.update(await self._get_multiple_to_dict(ENERGY_STORAGE_UNIT_1_PACK_1_REGISTERS))
                result.update(await self._get_multiple_to_dict(ENERGY_STORAGE_UNIT_1_PACK_2_REGISTERS))
                result.update(await self._get_multiple_to_dict(ENERGY_STORAGE_UNIT_1_PACK_TEMPERATURES))
...
# Registers that should be read for battery unit 1 
ENERGY_STORAGE_UNIT_1_REGISTERS = [
    rn.STORAGE_UNIT_1_RUNNING_STATUS,
    rn.STORAGE_UNIT_1_CHARGE_DISCHARGE_POWER,
    rn.STORAGE_UNIT_1_BUS_VOLTAGE,
    rn.STORAGE_UNIT_1_STATE_OF_CAPACITY,
    rn.STORAGE_UNIT_1_WORKING_MODE_B,
    rn.STORAGE_UNIT_1_FAULT_ID,
    rn.STORAGE_UNIT_1_CURRENT_DAY_CHARGE_CAPACITY,
    rn.STORAGE_UNIT_1_CURRENT_DAY_DISCHARGE_CAPACITY,
...
# Registers that should be read for battery unit 1 pack 1
ENERGY_STORAGE_UNIT_1_PACK_1_REGISTERS = [
    rn.STORAGE_UNIT_1_BATTERY_PACK_1_WORKING_STATUS,
    ...
    rn.STORAGE_UNIT_1_BATTERY_PACK_1_TOTAL_CHARGE,
    rn.STORAGE_UNIT_1_BATTERY_PACK_1_TOTAL_DISCHARGE,
]

# Registers that should be read for battery unit 1 pack 2
ENERGY_STORAGE_UNIT_1_PACK_2_REGISTERS = [
    rn.STORAGE_UNIT_1_BATTERY_PACK_2_WORKING_STATUS,
    ...
    rn.STORAGE_UNIT_1_BATTERY_PACK_2_TOTAL_CHARGE,
    rn.STORAGE_UNIT_1_BATTERY_PACK_2_TOTAL_DISCHARGE,
]

# Registers for battery pack temperatures
ENERGY_STORAGE_UNIT_1_PACK_TEMPERATURES = [
    rn.STORAGE_UNIT_1_BATTERY_PACK_1_MAXIMUM_TEMPERATURE,
    rn.STORAGE_UNIT_1_BATTERY_PACK_1_MINIMUM_TEMPERATURE,
    rn.STORAGE_UNIT_1_BATTERY_PACK_2_MAXIMUM_TEMPERATURE,
    rn.STORAGE_UNIT_1_BATTERY_PACK_2_MINIMUM_TEMPERATURE,
]
